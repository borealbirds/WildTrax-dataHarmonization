# Title: "WSI-BCHydro2006-11"
# Source dataset is an excel spreadsheet
# Author: "Melina Houle"
# Date: "November 26, 2025"
## Note on translation:
#   - Data not translated. Time is missing
#----------------------------------------------
#update.packages()
...
dataset <- "WSI-BCHydro2006-11"
dataset_code <- "WSI-BCHydro2006-11"
lu <- "./lookupTables"
...
if (length(list.files(project)) ==0) {
  pid <- WTpj_Tbl %>%
    filter(dataset_code =="WSI-BCHydro2006-11") %>%
